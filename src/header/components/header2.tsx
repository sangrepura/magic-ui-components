...
export default function Header2() {
  ...
  return (
    <header className="py-2 lg:py-5 px-2 w-full bg-transparent lg:relative">
      <nav className="max-w-4xl xl:max-w-5xl flex items-center justify-between mx-auto px-5 lg:px-2 py-2.5 border border-neutral-400/50 dark:border-neutral-700/50 lg:py-2 rounded-full">
        <a href="/">
          <div className="header-logo flex items-center gap-x-2.5 lg:pl-1.5">
            <img className="h-7 w-7" src={magicUiLogo} alt="MagicUI Logo" />
        ...
        <div className="hidden lg:flex items-center gap-x-10">
          <ul className="flex gap-x-5 text-base text-neutral-900 dark:text-white">
            {menuItems.map((menuItem, index) => (
              <li key={index}>
                <a href={menuItem.url}>
