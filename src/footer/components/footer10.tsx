...
export default function Footer10() {
  return (
    <section className="px-7 md:px-10 py-10">
      <div className="mx-auto flex max-w-5xl flex-col gap-x-5 gap-y-10 lg:flex-row md:items-start md:justify-between lg:px-10 xl:px-0">
        ...
        <div className="flex items-center justify-between mt-2.5">
          <div className="flex flex-col gap-y-1">
            ...
            <div className="flex items-center gap-x-2 pt-3.5">
              <input
                className="w-full p-2 rounded-lg border bg-neutral-50 dark:bg-neutral-900"
                type="text"
                name=""
                id=""
                placeholder="Email Address"
              />
              <button className="bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 px-5 py-2 rounded-lg">
                Subscribe
              </button>
            </div>
          </div>
