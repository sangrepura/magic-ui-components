...
export default function Pricing4() {
  return (
    <ResizablePanelGroup direction="horizontal" className="p-5">
      <ResizablePanel defaultSize={100} minSize={30} className="border">
        <section className="w-full py-12 md:py-24 lg:py-32 @container h-[200vh] flex items-center justify-center">
          <div className=" grid gap-6 px-4 md:px-6 @3xl:grid-cols-2 @5xl:grid-cols-3 @7xl:grid-cols-4 @5xl:gap-8 justify-center">
