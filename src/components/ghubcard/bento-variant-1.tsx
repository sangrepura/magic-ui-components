    ...
    >
      ...
      <AnimatePresence>
        <motion.img
          ...
          className="mt-10 w-full object-cover aspect-square rounded-t-xl flex items-end justify-end"
...
export default function BentoVariant1() {
  return (
